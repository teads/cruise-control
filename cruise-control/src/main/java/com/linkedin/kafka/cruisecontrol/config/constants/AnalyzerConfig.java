...
public class AnalyzerConfig {
  ...
  public static final double DEFAULT_TOPIC_LEADER_REPLICA_COUNT_BALANCE_THRESHOLD = 2.00;
  ...
  public static final int DEFAULT_TOPIC_LEADER_REPLICA_COUNT_BALANCE_MAX_GAP = 40;
